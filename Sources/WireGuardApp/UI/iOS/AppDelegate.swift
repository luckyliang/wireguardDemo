...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func _configOrginDemo(_ application: UIApplication, willFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) {
